...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        bg-slate-50">
            ...
            <a href="supervisor.php" class="bg-verde-500 rounded-md py-1 px-4 focus:bg-slate-50
...
hover:bg-verde-600 hover:border-verde-600 self-baseline">
        ...
        <th class="w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Telefone</th>
                        ...
                        <th class=" w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Cargo</th>
            ...
            foreach ($supervisores as $supervisor) {
                ...
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap phone_with_ddd" scope="col">' . $supervisor->getTelefone() . '</td>';
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap" scope="col">' . $supervisor->getEmail() . '</td>';
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap" scope="col">' . $supervisor->getNomeEmpresa() . '</td>';
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap" scope="col">' . $supervisor->getCargo() . '</td>';

                echo '<td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2">';
                echo "<a href='supervisor.php?id=" . $supervisor->getId() . "' class='bg-verde-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirsupervisor.php?id=" . $supervisor->getId() . "' class='bg-vermelho-500 rounded-full py-1 px-4 focus:bg-slate-50
                        ...
                        hover:bg-vermelho-600 hover:border-vermelho-600'>
