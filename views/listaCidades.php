...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <div class="flex justify-around items-center gap-2">
            ...
            <a href="cidade.php" class="bg-verde-500 rounded-md py-1 px-4 focus:bg-slate-50
        ...
        <th class=" w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Ações</th>
            ...
            foreach ($cidades as $cidade) {
                ...
                echo "<a href='cidade.php?id=" . $cidade->getId() . "' class='bg-verde-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirCidade.php?id=" . $cidade->getId() . " ' class='bg-vermelho-500 rounded-full py-1 px-4 focus:bg-slate-50
