...
<head>
    ...
    <title>Estágios IFRS -  Autoavaliação</title>
...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="AutoAvaliacao.php" class="bg-[#127852] rounded-full
        ...
        <table class="border-[1px] border-zinc-300 px-4">
            ...
            <tbody>
                <?php
                foreach ($autoAvaliacao as $avaliacao) {
                    echo '<tr>';
                    ...
                    echo "<a href='autoAvaliacao.php?id=" .  $avaliacao->getId() . "' class=' bg-[#127852] rounded-md py-1 px-4 hover:bg-zinc-50
                     text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-[#127852] hover:text-[#127852]'>
                        Editar
                        <span class='material-symbols-outlined'>edit</span>
                        </a>";
                    echo "<a href='excluirAutoAvaliacao.php?id=" .  $avaliacao->getId() . "' class=' bg-[#C62126] rounded-md py-1 px-4 hover:bg-zinc-50
