...
hover:bg-verde-600 hover:border-verde-600 self-baseline">
        ...
        <th class="w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Login</th>
            ...
            foreach ($usuarios as $usuario) {
                ...
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap" scope="col">' . $usuario->getLogin() . '</td>';
                echo '<td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2" scope="col">';

                echo "<a href='Usuario.php?id=" . $usuario->getId() . "' class='bg-verde-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirUsuario.php?id=" . $usuario->getId() . "' class='bg-vermelho-500 rounded-full py-1 px-4 focus:bg-slate-50
