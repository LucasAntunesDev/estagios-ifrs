...
<head>
    ...
    <title>Estágios IFRS - Áreas</title>
...
<body>
    ...
    bg-slate-50">
            ...
            <a href="area.php" class="bg-verde-500 rounded-md py-1 px-4 focus:bg-slate-50
...
hover:bg-verde-600 hover:border-verde-600 self-baseline">
        ...
        <th class="w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Ações</th>
            ...
            foreach ($areas as $area) {
                ...
                echo "<a href='Area.php?id=" . $area->getId() . "'class='bg-verde-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirArea.php?id=" . $area->getId() . "'  class='bg-vermelho-500 rounded-full py-1 px-4 focus:bg-slate-50
