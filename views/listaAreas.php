...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <div class="flex items-center gap-x-4 justify-start w-6/12 mb-4">
            ...
            <a href="area.php" class="bg-verde-1 rounded-full p-2 focus:bg-zinc-50
            ...
            <table class="table-auto">
                ...
                <tbody class="text-sm">
                    ...
                    foreach ($areas as $area) {
                        ...
                        echo "<a href='Area.php?id=" . $area->getId() . "'class='bg-verde-1 rounded-md py-1 px-4 focus:bg-zinc-50
                        ...
                        echo "<a href='excluirArea.php?id=" . $area->getId() . "'  class='bg-vermelho-1 rounded-md py-1 px-4 focus:bg-zinc-50
