...
<head>
    ...
    <title>Estágios IFRS - Formulário do Termo de Compromisso</title>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="termoCompromissos.php" class="ms-1 text-sm font-medium text-neutral-700 
                        hover:text-vermelho md:ms-2">Termo de Compromisso</a>
                    </div>
                </li>
