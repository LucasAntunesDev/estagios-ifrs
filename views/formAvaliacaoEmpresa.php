...
<head>
    ...
    <title>Estágios IFRS - Formulário de Avaliação Empresa</title>
...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <h1 class="font-bold text-4xl text-[#C62126] my-4">
            ...
            Formulário de Avaliação Empresa
        </h1>
        <a href="AvaliacaoEmpresas.php" class="text-gray-900 font-bold hover:text-gray-700">Voltar para a listagem</a>
