...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="TCC.php" class="bg-[#127852] rounded-full
        ...
        <table class="border-[1px] border-zinc-300 px-4">
            ...
            <tbody>
                ...
                foreach ($TCCS as $TCC) {
                    echo '<tr>';
                    echo '<td class="border-[1px] border-zinc-300 px-4">' . $TCC->getId() . '</td>';
                    ...
                    echo "<a href='TCC.php?id=" .  $TCC->getId() . "' class=' bg-[#127852] rounded-md py-1 px-4 hover:bg-zinc-50
                     text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-[#127852] hover:text-[#127852]'>
                        Editar
                        <span class='material-symbols-outlined'>edit</span>
                        </a>";
                    echo "<a href='excluirTCC.php?id=" .  $TCC->getId() . "' class=' bg-[#C62126] rounded-md py-1 px-4 hover:bg-zinc-50
