...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="TCC.php" class="bg-verde-1 rounded-full p-2 hover:bg-zinc-50
            ...
            <table class="max-w-full">
                ...
                <tbody>
                    ...
                    foreach ($TCCS as $TCC) {
                        ...
                        echo '<td class="p-1 w-min">' . $TCC->getId() . '</td>';
                        echo '<td class="border-[1px] border-zinc-300 px-4"><a href="uploads/' . $TCC->getUrl() . '" target="_blank">Clique aqui para abrir</a></td>';
                        echo '<td class="p-1 w-min">';

                        echo "<a href='TCC.php?id=" .  $TCC->getId() . "' class=' bg-verde-1 rounded-md py-1 px-4 hover:bg-zinc-50
                     text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-verde-1 hover:text-verde-1 transition duration-300 ease-in-out'>
                        ...
                        echo "<a href='excluirTCC.php?id=" .  $TCC->getId() . "' class=' bg-vermelho rounded-md py-1 px-4 hover:bg-zinc-50
