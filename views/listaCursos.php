...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <div class="flex justify-around items-center gap-2">
            ...
            <a href="curso.php" class="bg-verde-500 rounded-md py-1 px-4 focus:bg-slate-50
        ...
        <th class="w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">Coordenador</th>
            ...
            foreach ($cursos as $curso) {
                ...
                echo '<td class="pl-2 pr-1 w-fit py-5 whitespace-nowrap" scope="col">' . $curso->getNomeCoordenador() . '</td>';
                echo '<td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2" scope="col">';

                echo "<a href='Curso.php?id=" . $curso->getId() . "'class='bg-verde-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirCurso.php?id=" . $curso->getId() . "'  class='bg-vermelho-500 rounded-full py-1 px-4 focus:bg-slate-50
