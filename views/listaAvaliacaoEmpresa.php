...
<head>
    ...
    <title>Estágios IFRS - Avaliação da Empresa</title>
...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="avaliacaoEmpresa.php" class="bg-[#127852] rounded-full
        ...
        items-center transition duration-300 ease-in-out mb-2">
            ...
            Inserir Nova Avaliação Empresa
        ...
        <table class="border-[1px] border-zinc-300 px-4">
            ...
            <tbody>
                ...
                foreach ($avaliacaoEmpresa as $avaliacao) {
                    ...
                    echo "<a href='avaliacaoEmpresa.php?id=" .  $avaliacao->getId() . "' class=' bg-[#127852] rounded-md py-1 px-4 hover:bg-zinc-50
                     text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-[#127852] hover:text-[#127852]'>
                        Editar
                        <span class='material-symbols-outlined'>edit</span>
                        </a>";
                    echo "<a href='excluirAvaliacaoEmpresa.php?id=" .  $avaliacao->getId() . "' class=' bg-[#C62126] rounded-md py-1 px-4 hover:bg-zinc-50
