...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="avaliacaoEmpresa.php" class="bg-verde-1 rounded-full p-2 hover:bg-zinc-50
                ...
                <tbody>
                    ...
                    foreach ($avaliacaoEmpresa as $avaliacao) {
                     ...
                     text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-verde-1 hover:text-verde-1 transition duration-300 ease-in-out'>
                        ...
                        echo "<a href='excluirAvaliacaoEmpresa.php?id=" .  $avaliacao->getId() . "' class=' bg-vermelho rounded-md py-1 px-4 hover:bg-zinc-50
