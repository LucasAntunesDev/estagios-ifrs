...
<head>
    ...
    <title>Estágios IFRS - Gerenciar AutoAvaliação</title>
...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="autoavaliacoes.php" class="ms-1 text-sm font-medium text-neutral-700 
                        hover:text-vermelho md:ms-2">Autoavaliação</a>
                    </div>
                </li>
        ...
        <fieldset class="border-[1px] border-zinc-300 p-10 rounded-md w-[40rem]">
            ...
            <form action="salvarAutoAvaliacao.php" method="post" enctype="multipart/form-data" class="flex flex-col justify-center items-center gap-2">
                <input type="hidden" name="id" value='<?php echo $autoAvaliacao->getId(); ?>'>
                <div>
