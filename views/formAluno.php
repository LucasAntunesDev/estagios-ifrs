...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <h1 class="flex gap-x-3 items-center font-bold text-4xl text-vermelho my-4">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        hover:text-vermelho md:ms-2">Alunos</a>
                    </div>
                </li>
        ...
        <fieldset class="bg-zinc-50 p-10 rounded-md w-[40rem]">
            <form action="salvarAluno.php" method="post" class="flex flex-col items-center">
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800 w-available">
                        ...
                        <div>
                            <label for="data_nascimento" class="block text-sm font-medium leading-6 text-verde-1 mb-2">Data de Nascimento</label>
                    ...
                    <div class="flex gap-x-4 w-available">
                        ...
                        <div class="w-available">
                            <label for="telefone" class="block text-sm font-medium leading-6 text-verde-1 mb-2">Telefone (apenas números)</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800 w-available">
                    ...
                    <div class="flex gap-x-4 w-available">
                        <div class="w-available">
                            <label for="cpf" class="block text-sm font-medium leading-6 text-verde-1 mb-2">CPF (apenas números)</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800 w-available">
                        ...
                        <div class="w-available">
                            <label for="rg" class="block text-sm font-medium leading-6 text-verde-1 mb-2">RG</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800 w-available">
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <div>
                            <label for="matricula" class="block text-sm font-medium leading-6 text-verde-1 mb-2">Matricula</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800">
                        ...
                        <div>
                            <label for="ano_turma" class="block text-sm font-medium leading-6 text-verde-1 mb-2">Ano</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-2 outline-none text-zinc-800">
                        ...
                        <div>
                            <label for="id_curso" class="block text-sm font-medium leading-6 text-verde-1 mb-2">Curso</label>
