            ...
            <form action="salvarAluno.php" method="post" class="flex flex-col items-center">
                ...
                <div class="flex flex-col justify-center items-baseline gap-2">
                    ...
                    <div class="flex gap-x-4 w-available">
                        <div class="w-available">
                            <label for="nome"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Nome</label>
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                        ...
                        <div>
                            <label for="data_nascimento"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Data de
                                Nascimento</label>

                            <div class="relative">

                                <input type="date" id="data_nascimento" name="data_nascimento"
                                    value=" <?php echo $aluno->getDataNascimento(); ?>" class="rounded-md 
                    border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                    focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800">

                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xm="numberano_tuermlns=" http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                        fill="currentColor" class="w-5 h-5 fill-neutral-700">
                                        <path
                    ...
                    <div class="flex gap-x-4 w-available">
                        ...
                        <div class="w-available">
                            <label for="telefone"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Telefone (apenas
                                números)</label>

                            <div class="relative">
                                <input type="number" id="telefone" name="telefone"
                                    value='<?php echo $aluno->getTelefone(); ?>' class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="w-available">
                            <label for="email"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Email</label>

                            <div class="relative">
                                <input type="email" id="email" name="email" value='<?php echo $aluno->getEmail(); ?>'
                                    class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                    ...
                    <div class="flex gap-x-4 w-available">
                        <div class="w-available">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="cpf" maxlength="11" minlength="11" id="cpf"
                                    value="<?php echo $aluno->getCPF(); ?>" class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                ...
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                    ...
                    <div class="flex gap-x-4 w-available">
                        <div class="w-available">
                            <label for="endereco"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Endereço</label>

                            <div class="relative">
                                <input type="text" id="endereco" name="endereco"
                                    value=" <?php echo $aluno->getEndereco(); ?>" class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800 w-available">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div class="w-available">
                            <label for="id_cidade"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Cidade</label>
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <div>
                            <label for="matricula"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Matricula</label>

                            <div class="relative">
                                <input type="number" id="matricula" name="matricula"
                                    value='<?php echo $aluno->getMatricula(); ?>' class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        ...
                        <div>
                            <label for="ano_turma"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Ano</label>

                            <div class="relative">
                                <input type="number" id="ano_turma" name="ano_turma"
                                    value='<?php echo $aluno->getAnoTurma(); ?>' class="rounded-md 
                border-0 py-1.5 pr-7 pl-10 ring-1 ring-inset ring-neutral-300
                focus:ring-2 focus:ring-inset focus:ring-verde-400 outline-none text-zinc-800">
                        ...
                        <div>
                            <label for="id_curso"
                                class="block text-sm font-medium leading-6 text-verde-500 mb-2">Curso</label>
                    ...
                    <button type="submit"
                        class="bg-verde-500 rounded-md py-1 px-20 focus:bg-slate-50
