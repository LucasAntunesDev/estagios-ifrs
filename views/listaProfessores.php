        ...
        <div class="relative overflow-x-auto max-w-11/12 border-gray-200 border rounded-md">
            <table class="table-auto">
                ...
                <tbody class="text-sm">
                    ...
                    if (isset($_GET['descrescente'])) rsort($professores);

                    foreach ($professores as $professor) {
                        echo '<tr class="border-1 border-neutral-200 border-b even:bg-zinc-50">';
                        echo '<td class="pl-1 pr-3 w-fit">' . $professor->getId() . '</td>';
                        echo '<td class="pl-1 pr-3 w-fit">' . $professor->getNome() . '</td>';
                        echo '<td class="pl-1 pr-3 w-fit">' . $professor->getEmail() . '</td>';
                        echo '<td class="pl-1 pr-3 w-fit">' . $professor->getNomeArea() . '</td>';
