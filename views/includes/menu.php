...
transition ease-in-out duration-300 cursor-pointer">
    ...
    if (isset($_SESSION['usuario'])) {
        echo "<div class='flex justify-center items-center gap-x-2 hover:text-zinc-200 hover:cursor-pointer'>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' class='w-6 h-6'>
                    <path fill-rule='evenodd' d='M18.685 19.097A9.723 9.723 0 0021.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 
                    6.615 2.25 12a9.723 9.723 0 003.065 7.097A9.716 9.716 0 0012 21.75a9.716 9.716 0 006.685-2.653zm-12.54-1.285A7.486
                     7.486 0 0112 15a7.486 7.486 0 015.855 2.812A8.224 8.224 0 0112 20.25a8.224 8.224 0 01-5.855-2.438zM15.75 9a3.75 3.75
                      0 11-7.5 0 3.75 3.75 0 017.5 0z' clip-rule='evenodd' />
                </svg>

                <span class='font-bold text-zinc-50'>" . $_SESSION['usuario']->getNome() . "</span>
        </div>";
    } else {
        echo "<div class='flex justify-center items-center gap-x-2 hover:text-zinc-200 hover:cursor-pointer'>
        <a href='login.php' class='flex gap-x-2 font-bold hover:text-zinc-200'>
        
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' class='w-6 h-6'>
            <path fill-rule='evenodd' d='M18.685 19.097A9.723 9.723 0 0021.75 12c0-5.385-4.365-9.75-9.75-9.75S2.25 
            6.615 2.25 12a9.723 9.723 0 003.065 7.097A9.716 9.716 0 0012 21.75a9.716 9.716 0 006.685-2.653zm-12.54
            -1.285A7.486 7.486 0 0112 15a7.486 7.486 0 015.855 2.812A8.224 8.224 0 0112 20.25a8.224 8.224 0
             01-5.855-2.438zM15.75 9a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z' clip-rule='evenodd' />
        </svg>
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownDefaultButton">
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="usuarios.php">
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    ...
                    <a class="flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="alunos.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="estagiosAlunos.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="supervisores.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="professores.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                            <path d="M10 9a3 3 0 100-6 3 3 0 000 6zM6 8a2 2 0 11-4 0 2 2 0 014 0zM1.49 15.326a.78.78 0 01-.358-.442 3 3 0 014.308-3.516 6.484 6.484 0 00-1.905 3.959c-.023.222-.014.442.025.654a4.97 4.97 0 01-2.07-.655zM16.44 15.98a4.97 4.97 0 002.07-.654.78.78 0 00.357-.442 3 3 0 00-4.308-3.517 6.484 6.484 0 011.907 3.96 2.32 2.32 0 01-.026.654zM18 8a2 2 0 11-4 0 2 2 0 014 0zM5.304 16.19a.844.844 0 01-.277-.71 5 5 0 019.947 0 .843.843 0 01-.277.71A6.975 6.975 0 0110 18a6.974 6.974 0 01-4.696-1.81z" />
                        </svg>
                        Professor
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="cidades.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="cursos.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                            <path fill-rule="evenodd" d="M9.664 1.319a.75.75 0 01.672 0 41.059 41.059 0 018.198 5.424.75.75 0 01-.254 1.285 31.372 31.372 0 00-7.86 3.83.75.75 0 01-.84 0 31.508 31.508 0 00-2.08-1.287V9.394c0-.244.116-.463.302-.592a35.504 35.504 0 013.305-2.033.75.75 0 00-.714-1.319 37 37 0 00-3.446 2.12A2.216 2.216 0 006 9.393v.38a31.293 31.293 0 00-4.28-1.746.75.75 0 01-.254-1.285 41.059 41.059 0 018.198-5.424zM6 11.459a29.848 29.848 0 00-2.455-1.158 41.029 41.029 0 00-.39 3.114.75.75 0 00.419.74c.528.256 1.046.53 1.554.82-.21.324-.455.63-.739.914a.75.75 0 101.06 1.06c.37-.369.69-.77.96-1.193a26.61 26.61 0 013.095 2.348.75.75 0 00.992 0 26.547 26.547 0 015.93-3.95.75.75 0 00.42-.739 41.053 41.053 0 00-.39-3.114 29.925 29.925 0 00-5.199 2.801 2.25 2.25 0 01-2.514 0c-.41-.275-.826-.541-1.25-.797a6.985 6.985 0 01-1.084 3.45 26.503 26.503 0 00-1.281-.78A5.487 5.487 0 006 12v-.54z" clip-rule="evenodd" />
                        </svg>
                        Curso
                ...
                <li class="hover:bg-zinc-100 rounded-md py-1 mx-2">
                    <a class="block flex items-center gap-x-2 py-1 px-3 text-neutral-700  font-bold" href="areas.php">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                ...
                <li class="mt-3 border-t-[1px] border-t-neutral-300">
                    <a class="mt-2 flex items-center gap-x-2 block py-1 px-3 text-red-500 hover:text-red-800 font-bold" href="logout.php">
                        Sair
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
