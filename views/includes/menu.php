                ...
                <div class='z-50 hidden my-1 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow' id='user-dropdown'>
                    ...
                    <a href='usuario.php?id=" . $_SESSION['usuario']->getId() . "'>
                        <div class='flex items-center gap-x-1 px-4 py-2 hover:bg-zinc-100 rounded-md m-2'>
                            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' class='w-7 h-7 fill-neutral-900'>
                                <path fill-rule='evenodd' d='M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-5.5-2.5a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zM10 12a5.99 5.99 0 00-4.793 2.39A6.483 6.483 0 0010 16.5a6.483 6.483 0 004.793-2.11A5.99 5.99 0 0010 12z' clip-rule='evenodd' />
                            </svg>
                            <span class='block font-bold text-gray-900'>" . $_SESSION['usuario']->getNome() . "</span>
                        </div>
                    </a>

                    <a href='usuarios.php'>
                    <div class='flex items-center gap-x-1 px-4 py-2 hover:bg-zinc-100 rounded-md m-2'>
                        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' class='w-6 h-6 fill-neutral-900'>
                        ...
                        <span class='block font-bold text-gray-900'>Gerenciar usuários</span>
                    </div>
                </a>
