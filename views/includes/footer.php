<footer class="bg-white shadow mt-8 border-t-neutral-200 border-t-[1px]">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:pt-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-600 sm:mb-0 gap-y-2 md:gap-y-0">
                <li>
                    <a href="index.php#sobre" class="hover:underline me-4 md:me-6">Sobre</a>
                </li>
                <li>
                    <a href="#" class="flex items-center gap-x-2 me-4 md:me-6">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 fill-gray-600">
                ...
                <li>
                    <a href="#" class="flex items-center gap-x-2 me-4 md:me-6">
                        ...
                        estagios@bento.ifrs.edu.br
                    </a>
                </li>
            </ul>
        </div>
        <hr class="my-6 border-neutral-200 sm:mx-auto lg:my-8" />
        <span class="block text-sm text-gray-600 sm:text-center">© 2023
            <a href="index.php" class="hover:underline">Estágios IFRS</a>. Todos os direitos reservados.
        </span>
    </div>
</footer>