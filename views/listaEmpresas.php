...
<body>
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        ...
        <a href="empresa.php" class="bg-[#127852] rounded-full
        ...
        <div class="flex overflow-x-auto overflow-y-auto w-11/12 border-[1px] border-zinc-300 h-screen">
            <table class="border-[1px] border-zinc-300 px-4">
                <thead>
                    <tr>
                        <th class="text-xl font-bold border-[1px] border-zinc-300 px-1">Numero Convênio</th>
                        ...
                        <th class="text-xl font-bold border-[1px] border-zinc-300 px-1">CNPJ</th>
                ...
                <tbody>
                    ...
                    foreach ($empresas as $empresa) {
                            echo '<tr>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getId() . '</td>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getNome() . '</td>';                   
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getEndereco() . '</td>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getTelefone() . '</td>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getEmail() . '</td>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getCNPJ() . '</td>';
                            echo '<td class="border-[1px] border-zinc-300 px-4">' . $empresa->getIdCidade() . '</td>';
                            echo '<td class="border-[1px]  px-4 flex flex-col">';
    
                            echo "<a href='empresa.php?id=" . $empresa->getId() . "' class=' bg-[#127852] rounded-md py-1 px-4 hover:bg-zinc-50
                         text-zinc-50 flex items-center mt-4 gap-x-2 justify-center border-2 border-[#127852] hover:text-[#127852]'>
                            Editar
                            <span class='material-symbols-outlined'>edit</span>
                            </a>";
                            echo "<a href='excluirEmpresa.php?id=" . $empresa->getId() . "' class=' bg-[#C62126] rounded-md py-1 px-4 hover:bg-zinc-50
