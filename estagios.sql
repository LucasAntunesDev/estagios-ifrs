...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Out-2023 às 22:46
...
INSERT INTO `aluno` (`id_aluno`, `matricula`, `nome`, `datanasc`, `email`, `cpf`, `rg`, `endereco`, `telefone`, `ano_turma`, `id_cidade`, `curso_id`) VALUES
...
/* Inserindo dados na Tabela 'autoavaliacao' */
...
/* Inserindo dados na Tabela 'avaliacao_empresa' */
...
INSERT INTO `empresa` (`numero_convenio`, `nome`, `endereco`, `telefone`, `email`, `cnpj`, `id_cidade`) VALUES
(1, 'Empresa 1', 'Endereço 1', 1234567890, 'empresa1@example.com', 2147483647, 1),
(2, 'Empresa 2', 'Endereço 2', 2147483647, 'empresa2@example.com', 2147483647, 2),
(3, 'Empresa 3', 'Endereço 3', 2147483647, 'empresa3@example.com', 2147483647, 3),
(4, 'Empresa 4', 'Endereço 4', 2147483647, 'empresa4@example.com', 2147483647, 1),
(5, 'Empresa 5', 'Endereço 5', 2147483647, 'empresa5@example.com', 2147483647, 2),
(6, 'Empresa 6', 'Endereço 6', 2147483647, 'empresa6@example.com', 2147483647, 3);
...
/* Inserindo dados na Tabela 'estagio_aluno' */
INSERT INTO `estagio_aluno` (`id`, `id_aluno`, `empresa_numero_convenio`, `carga_horaria`, `id_coordenador`, `tipo_processo_estagio`, `encaminhamentos`, `situacao_estagio`, `data_inicio`, `previsao_fim`, `id_orientador`, `id_coorientador`, `supervisor`, `data_fim`, `id_area`, `id_avaliacao_empresa`, `id_termo_compromisso`, `id_plano_atividades`, `id_autoavaliacao`, `id_tcc`) VALUES
(1, 1, 1, 30, 1, 'Estágio Curricular', 301, 'Não Iniciado', '2023-10-01', '0000-00-00', 1, 1, 1, '2023-12-31', 1, 1, 1, 1, 1, 1),
(2, 2, 2, 20, 2, 'Estágio Profissional', 302, 'Em andamento', '2023-09-15', '0000-00-00', 2, 2, 2, '2024-02-29', 2, 2, 2, 2, 2, 2),
(3, 3, NULL, 40, 3, 'Estágio Voluntário', 303, 'Finalizado', '2023-11-05', '2023-12-15', 3, 3, 3, '2023-12-15', 3, 3, 3, 3, 3, 3),
(4, 4, 4, 20, 4, 'Estágio Profissional', 302, 'Finalizado', '2023-09-10', '2023-12-09', 4, 4, 4, '2024-03-15', 4, NULL, 4, 4, NULL, NULL),
(5, 5, 5, 35, 5, 'Estágio Curricular', 301, 'Finalizado', '2023-08-01', '2023-10-31', NULL, 5, 5, '2023-10-31', 5, 5, NULL, NULL, 5, 5),
(6, 6, 6, 40, 6, 'Estágio Voluntário', 303, 'Não Iniciado', '2023-12-01', '2024-03-01', 6, 6, 6, '2024-03-01', 6, 6, NULL, NULL, 6, 6);
...
/* Inserindo dados na Tabela 'plano_atividades' */
...
INSERT INTO `professor` (`id_professor`, `nome`, `email`, `id_area`) VALUES
...
INSERT INTO `supervisor` (`id_supervisor`, `nome`, `telefone`, `email`, `empresa_numero_convenio`, `cargo`) VALUES
...
ALTER TABLE `aluno`
  ...
  ADD KEY `fk_aluno_curso1` (`curso_id`);
...
ALTER TABLE `estagio_aluno`
  ...
  ADD UNIQUE KEY `supervisor_UNIQUE` (`supervisor`),
  ...
  ADD KEY `fk_estagio_aluno_supervisor1_idx` (`supervisor`),
...
ALTER TABLE `empresa`
  MODIFY `numero_convenio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `supervisor`
  MODIFY `id_supervisor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
