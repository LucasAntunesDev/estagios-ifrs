...
INSERT INTO `estagio_aluno` (`id`, `id_aluno`, `empresa_numero_convenio`, `carga_horaria`, `id_coordenador`, `tipo_processo_estagio`, `encaminhamentos`, `situacao_estagio`, `data_inicio`, `previsao_fim`, `id_orientador`, `id_coorientador`, `id_supervisor`, `data_fim`, `id_area`, `id_avaliacao_empresa`, `id_termo_compromisso`, `id_plano_atividades`, `id_autoavaliacao`, `id_tcc`) VALUES
...
--
ALTER TABLE `empresa`
  MODIFY `numero_convenio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
